...
class HttpAuthTest {
    ...
    private static final AtomicInteger portCounter = new AtomicInteger(8600)
    ...
    void setup() {
        ...
        serverSystem = new ActorSystem('httpAuthTestSystem')
    ...
    void test_valid_token_accepted() {
        ...
        serverTransport = new HttpTransport(serverSystem, testPort, true, null, authConfig)
        serverTransport.start()
        
        Thread.sleep(500) // Let server start
        
        // Client with valid token
        clientTransport = new HttpTransport(null, 0, false, null, null)
        ...
        def future = clientTransport.ask(
            "http://localhost:${testPort}/httpAuthTestSystem/echo",
            "Hello Auth",
    ...
    void test_fire_and_forget_with_auth() {
        ...
        clientTransport.tell(
            "http://localhost:${testPort}/httpAuthTestSystem/counter",
            "increment"
        )
